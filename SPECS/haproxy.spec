...
%build
%{__make} USE_OPENSSL=yes USE_PCRE=1 USE_SYSTEMD=1 USE_LUA=yes LUA_LIB=/usr/local/lib/ LUA_INC=/usr/local/include/ USE_ZLIB=1 DEBUG="" ARCH=%{_target_cpu} TARGET=linux-glibc
